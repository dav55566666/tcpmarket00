...
import Useritem from "../../unikit/useritem"
import 'antd/dist/antd.css';
import Sotrudmodal from "../../modals/sotrudmodal"
import Sotrudmodalpart2 from "../../modals/sotrudmodalpart2"
import Sotrudmodalcustom from "../../modals/sotrudcustom"
function opensotrudmodal() {
 document.getElementById('sotrudmodal').style.display = "block";
}
const menu = (
...
const menu2 = (
  <Menu className="sotruddownabsalut">
    <Menu.Item><p>Все</p></Menu.Item>
    <Menu.Item><p>Все</p></Menu.Item>
    <Menu.Item><p>Все</p></Menu.Item>
    <Menu.Item><p>Все</p></Menu.Item>
    <Menu.Item><p>Все</p></Menu.Item>
    ...
    return (
        ...
        <Sotrudmodalcustom />
            <div className="sotrud-cont">
              ...
              <div className="sotrud-cont-right">
                <div className="sotrud-cont-right-title">
                  <button onClick={opensotrudmodal}><img src="/icons/fi-sr-plus-small.svg" />Добавить</button>
                  <div className="sotrud-cont-right-title-drop">
                    <p>Должность:</p>
                    <Dropdown overlay={menu2}>
                      <div className="sotruddropflex">
                        <p>Все</p>
                ...
                <div className="sotrud-cont-right-flex">
                  <Useritem userimg={"/icons/userphoto.png"} username={"Кристина"} userwork={"Менеджер"} />
                  <Useritem userimg={"/icons/userphoto.png"} username={"Кристина"} userwork={"Менеджер"} />
                </div>
              </div>
            </div>
